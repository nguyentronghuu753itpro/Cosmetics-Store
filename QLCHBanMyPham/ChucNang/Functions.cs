...
namespace QLCHBanMyPham.ChucNang
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-0B9GDJ8\SERVER;Initial Catalog=QLCHBanMyPham;Persist Security Info=True;User ID=sa;Password=123;";
            Con.Open();
        }
